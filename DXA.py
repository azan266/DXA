...
"""%(N))                                                    
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Nama       : AZAN X. 
 [\x1b[1;96m+%s] Github      : https://github.com/Azan266
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
def kontol():
    os.system("clear")
    print(f""" 
...
def menu():
	...
	sol().print(fx)
	#print(x+'['+h+'•'+x+'] \033[0;34mNama AZAN ALI  : '+str(my_name))
	#print(x+'['+h+'•'+x+'] \033[0;34mID AZAN X.    : '+str(my_id))
	#print(x+'['+h+'•'+x+'] \033[93mERROR : '+str(birth))
	print(x+'['+h+'•'+x+'] \033[923mERROR  : '+str(sh['origin']))
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [AXB] %s/%s •_• [OK] %s •_• [CP] %s •_• %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
